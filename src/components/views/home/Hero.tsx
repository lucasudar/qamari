        ...
        <section className="bg-gray-50 dark:bg-background py-14">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl px-4">
                <div className="flex flex-col justify-center space-y-6">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-foreground mb-4 leading-tight">
                        We can build anything that you want
                    </h1>
                    <p className="text-lg text-gray-600 dark:text-foreground/80 mb-4">
                        Our team of professionals will help you to build your dream project.
                    </p>
                    <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-foreground/80">
